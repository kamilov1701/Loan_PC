  ...
  render() {
    return (
      <div>
        ...
        <section>
          <div className='container flex items-center justify-between'>
            <div className='flex gap-[5px] items-center'>
              <h1 className='text-[21px] font-bold'>Qarz qo'shish</h1>
        ...
        <main>
          <section className='bg-[#ffff] shadow-lg rounded-xl w-[700px] h-[530px] mt-[24px] p-[29px]'>
            <div>
            ...
            <div className='bg-[#EFF6FF] max-w-[642px] w-full h-[45px] text-[#2563EB] text-[23px] flex justify-between items-center px-[16px] py-[14px] rounded-[8px] mt-[24px] font-semibold'>
              <p>Qo'shilgandagi qarz miqdori</p>
              <p>2 750 000 UZS</p>
            </div>
            <div className='flex gap-[12px] pt-[26px]'>
              <button className='w-[114px] h-[36px] bg-[#2563EB] rounded-[8px] text-[#fff] text-[14px] font-semibold p-[4px]'><a href="./List">Qarz qo'shish</a></button>
