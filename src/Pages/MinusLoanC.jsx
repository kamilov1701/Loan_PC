      ...
      <div>
        ...
        <div className='flex justify-between bg-[#FFF] w-full h-[64px] border-b-[1px] solid-[#E5E7EB]'>
          <div className='flex gap-[6px]'>
            <h1 className='text-[17px] font-bold'>Qarz Ayirish</h1>
            <h2 className='text-[14px] font-normal'>Dilnoza Yusupova</h2>
          </div>
          <div>
        ...
        <main>
          <section className='bg-[#ffff] shadow-lg rounded-xl max-w-[700px] w-full h-[530px] mt-[24px] p-[29px]'>
            ...
            <div className='bg-[#ECFDF5] max-w-[642px] w-full h-[45px] text-[#10B981] text-[23px] flex justify-between items-center px-[16px] py-[14px] rounded-[8px] mt-[24px] font-semibold'>
              <p>Qarz ayirilgandagi qarz miqdori</p>
              <p>2 750 000 UZS</p>
            </div>
